...
dwgrep: dwgrep.o parser.o lexer.o tree.o tree_cr.o constant.o op.o	\
	...
	overload.o value.o value-closure.o value-cst.o value-dw.o	\
	value-seq.o value-str.o init.o dwcst.o
...
test-parser: test-parser.o parser.o lexer.o tree.o tree_cr.o build.o	\
	...
	builtin-shf.o builtin-closure.o builtin-cmp.o builtin-cst.o
