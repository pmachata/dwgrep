...
dwgrep: dwgrep.o parser.o lexer.o tree.o tree_cr.o constant.o op.o	\
	...
	builtin-elem.o builtin-length.o builtin-value.o overload.o	\
...
test-parser: test-parser.o parser.o lexer.o tree.o tree_cr.o build.o	\
	...
	value-str.o value-seq.o builtin-shf.o builtin-arith.o		\
	builtin-cmp.o builtin-cst.o builtin-add.o builtin-length.o	\
