...
dwgrep: dwgrep.o parser.o lexer.o tree.o tree_cr.o constant.o op.o	\
	...
	builtin-arith.o builtin-dw.o builtin-closure.o builtin-cmp.o	\
	builtin-cst.o overload.o value.o value-closure.o value-cst.o	\
...
test-parser: test-parser.o parser.o lexer.o tree.o tree_cr.o build.o	\
	...
	value-closure.o value-cst.o value-str.o value-seq.o		\
	builtin-shf.o builtin-arith.o builtin-closure.o builtin-cmp.o	\
	builtin-cst.o
